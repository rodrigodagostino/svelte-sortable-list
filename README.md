...
| `ondragstart` | `SortableList.RootEvents['ondragstart']` | Item begins being dragged by pointer device or keyboard                                    | <pre>{<br>&nbsp;&nbsp;deviceType: 'pointer' \| 'keyboard',<br>&nbsp;&nbsp;draggedItem: HTMLLIElement,<br>&nbsp;&nbsp;draggedItemId: string,<br>&nbsp;&nbsp;draggedItemIndex: number,<br>&nbsp;&nbsp;isBetweenBounds: boolean,<br>&nbsp;&nbsp;canRemoveOnDropOut: boolean<br>}</pre>                                                                                                                                                                                    |
| `ondrag`      | `SortableList.RootEvents['ondrag']`      | Dragged item is moved by pointer device or keyboard (fires every few hundred milliseconds) | <pre>{<br>&nbsp;&nbsp;deviceType: 'pointer' \| 'keyboard',<br>&nbsp;&nbsp;draggedItem: HTMLLIElement,<br>&nbsp;&nbsp;draggedItemId: string,<br>&nbsp;&nbsp;draggedItemIndex: number,<br>&nbsp;&nbsp;targetItem: HTMLLIElement \| null,<br>&nbsp;&nbsp;targetItemId: string \| null,<br>&nbsp;&nbsp;targetItemIndex: number \| null,<br>&nbsp;&nbsp;isBetweenBounds: boolean,<br>&nbsp;&nbsp;canRemoveOnDropOut: boolean<br>}</pre>                                     |
| `ondrop`      | `SortableList.RootEvents['ondrop']`      | Dragged item is released by pointer device or keyboard                                     | <pre>{<br>&nbsp;&nbsp;deviceType: 'pointer' \| 'keyboard',<br>&nbsp;&nbsp;draggedItem: HTMLLIElement,<br>&nbsp;&nbsp;draggedItemId: string,<br>&nbsp;&nbsp;draggedItemIndex: number,<br>&nbsp;&nbsp;targetItem: HTMLLIElement \| null,<br>&nbsp;&nbsp;targetItemId: string \| null,<br>&nbsp;&nbsp;targetItemIndex: number \| null,<br>&nbsp;&nbsp;isBetweenBounds: boolean,<br>&nbsp;&nbsp;canRemoveOnDropOut: boolean<br>}</pre>                                     |
| `ondragend`   | `SortableList.RootEvents['ondragend']`   | Dragged item reaches its final destination after being released                            | <pre>{<br>&nbsp;&nbsp;deviceType: 'pointer' \| 'keyboard',<br>&nbsp;&nbsp;draggedItem: HTMLLIElement,<br>&nbsp;&nbsp;draggedItemId: string,<br>&nbsp;&nbsp;draggedItemIndex: number,<br>&nbsp;&nbsp;targetItem: HTMLLIElement \| null,<br>&nbsp;&nbsp;targetItemId: string \| null,<br>&nbsp;&nbsp;targetItemIndex: number \| null,<br>&nbsp;&nbsp;isBetweenBounds: boolean,<br>&nbsp;&nbsp;canRemoveOnDropOut: boolean,<br>&nbsp;&nbsp;isCanceled: boolean<br>}</pre> |
