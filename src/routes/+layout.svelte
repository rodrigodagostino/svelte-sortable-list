<script lang="ts">
	...
	const links = [
		...
		{ text: 'Interactive elements', path: '/interactive-elements' },
		{ text: 'Interactive elements with handle', path: '/interactive-elements-with-handle' },
	...
	<nav id="app-nav" class="app-nav" aria-hidden={!isMenuExpanded} inert={!isMenuExpanded}>
		<div class="container">
			<div class="app-nav__header">
				...
				<a
					class="link link--npm"
					href="https://www.npmjs.com/package/@rodrigodagostino/svelte-sortable-list"
					target="_blank"
				>
